...
Vue 实现了自己的组件模型，但也很好地与原生 Web Components 兼容。如果你想知道 Vue 组件与原生 Web Components 相比如何，可以 [阅读此章节](/guide/advanced/web-components.html#web-components-vs-vue-components)。
...
:::tip
我们会在接下来的指引中使用 SFC 语法，无论您是否使用构建步骤，组件相关的概念都是相同的。[示例](/examples/) 一节中展示了两种场景中的组件使用情况。
:::
