...
- [Nightwatch v2](https://v2.nightwatchjs.org/) 是另一个 E2E 测试运行器，在 v2 版本中对 Vue 组件测试提供了支持（目前处于 beta 阶段 - 使用 Nightwatch v2 的 [示例项目](https://github.com/nightwatchjs-community/todo-vue)）。
